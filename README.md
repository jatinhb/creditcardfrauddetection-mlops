...
```bash
git clone https://github.com/jatinbhavsar/creditCardFraudDetection.git
...
Jatin Bhavsar is a Technical Program Manager and Scrum Master with over 24 years of professional experience in AI, Machine Learning, DevOps, and Cloud Solutions. He specializes in risk analysis, product architecture, and driving iterative design through agile methodologies to deliver impactful results.

**Contact Information:**
- Email: jatin.k.bhavsar@gmail.com
- GitHub: jatinbhavsar
- LinkedIn: jatinbhavsar